...
return new class extends Migration
{
    ...
    {
        Schema::create('formulaire_exp_4_2_a_suites', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('formulaire_type')->default('A_SUITE')->index();
    ...
    {
        Schema::dropIfExists('formulaire_exp_4_2_a_suites');
    }
};
