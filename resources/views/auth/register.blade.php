...
<style>
    ...
    .auth-field:nth-child(4) { animation-delay: 0.7s; }
    .auth-field:nth-child(5) { animation-delay: 0.8s; }
...
<div class="auth-wrapper">
    ...
    <div class="auth-card">
        <div class="auth-header">
            <div class="auth-badge">Creation de compte</div>
            <h1 class="auth-title">Creer un compte</h1>
            <p class="auth-subtitle">Rejoignez la plateforme et commencez a organiser vos dossiers.</p>
        </div>
        ...
        <div class="auth-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="auth-field">
                    ...
                    <input
                        id="nom"
                        type="text"
                        class="auth-input @error('nom') is-invalid @enderror"
                        name="nom"
                        value="{{ old('nom') }}"
                        required
                ...
                <div class="auth-field">
                    <label for="prenom" class="auth-label">Prenom</label>
                    <input
                        id="prenom"
                        type="text"
                        class="auth-input @error('prenom') is-invalid @enderror"
                        name="prenom"
                        value="{{ old('prenom') }}"
                        required
                ...
                <div class="auth-field">
                    <label for="password-confirm" class="auth-label">Confirmer le mot de passe</label>
                    <input
                        id="password-confirm"
                        type="password"
                        class="auth-input"
            ...
            <div class="auth-footer">
                <div>Vous avez deja un compte ?</div>
                <a href="{{ route('login') }}" class="auth-secondary">
                    Se connecter
                </a>
            </div>
        </div>
