<div style="font-family:Arial, sans-serif; font-size:11px; color:#000; line-height:1.4;">
    <h2 style="text-align:center; margin-bottom:4px;">Formulaire FIN 3.4 (a)</h2>
    <h3 style="text-align:center; margin-top:0; margin-bottom:14px;">Modèle d'attestation de capacité financière</h3>

    <div style="font-size:11px; margin-bottom:14px;">
        Documents d'attestation de capacité financière émis par un établissement de crédit ou un organisme financier reconnu.
    </div>
