<div id="formulaire-exp-4-2-a-step6">
    ...
    <div class="wizard-field" style="margin-bottom:16px;">
        <label for="exp42a-files" class="wizard-label">Pièces jointes (Documents d'expérience)</label>
        <input type="file" id="exp42a-files" name="fichiers[{{ $docId }}][]" class="form-control" multiple accept="image/*,application/pdf" style="margin-bottom:8px;">
