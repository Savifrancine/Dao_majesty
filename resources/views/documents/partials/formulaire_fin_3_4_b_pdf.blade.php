<div style="font-family:Arial, sans-serif; font-size:11px; color:#000; line-height:1.4; text-align:center;">
    <h2 style="text-align:center; margin-bottom:4px; font-size:13px; font-weight:700;">Formulaire FIN 3.4 (b)</h2>
    <h3 style="text-align:center; margin-top:0; margin-bottom:14px; font-size:11px;">Modèle de lettre de confirmation de la capacité financière</h3>
