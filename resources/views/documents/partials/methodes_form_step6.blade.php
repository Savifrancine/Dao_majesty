                    ...
                    <table class="table" style="width:100%; border-collapse:collapse; font-size:12px;">
                        <thead>
                            <tr>
                                ...
                                <th style="border:1px solid #ccc; padding:8px; width:45%;">Désignation des produits</th>
                                <th style="border:1px solid #ccc; padding:8px; width:12%;">Date de réalisation n.a</th>
                                ...
                                <th style="border:1px solid #ccc; padding:8px; width:13%;">Total par article (Col 4°)</th>
                        ...
                        <tbody class="bordereau-lines">
                            @foreach($section['lignes'] as $lineIndex => $ligne)
                                <tr>
                                    ...
                                    <td style="border:1px solid #ccc; padding:8px; vertical-align:top;">
                                        <input type="text" class="form-control wizard-input methodes-total" value="{{ $ligne['montant'] ?? ($ligne['prix_unitaire'] ?? '') }}" disabled>
                                    </td>
    ...
    (function () {
        ...
        function createLineRow(sectionIndex, designation = '', date = '', quantity = '1', price = '') {
            ...
            row.innerHTML = `
                ...
                <td style="border:1px solid #ccc; padding:8px; vertical-align:top;">
                    <input type="text" name="sections[${sectionIndex}][lignes][0][prix_unitaire]" class="form-control wizard-input methodes-price" placeholder="150000" value="${price}">
                </td>
                <td style="border:1px solid #ccc; padding:8px; vertical-align:top;">
                    <input type="text" class="form-control wizard-input methodes-total" value="" disabled>
                </td>
                <td style="border:1px solid #ccc; padding:8px; vertical-align:top; text-align:center;">
                    <button type="button" class="btn btn-sm btn-danger removeBordereauLine" style="padding:0.25rem 0.45rem;">×</button>
                </td>
        ...
        function updateRowTotal(row) {
            ...
            const totalDisplay = row.querySelector('input.methodes-total');
