...
<div class="wizard-wrapper">
    ...
    <div class="wizard-card">
        <div class="wizard-header">
            <div class="wizard-badge">Etape 2 sur 6</div>
            <h1 class="wizard-title">Type de dossier</h1>
            <p class="wizard-subtitle">Selectionnez le type de dossier que vous souhaitez creer.</p>
        </div>

        <div class="wizard-body">
            <div class="wizard-step">
                <span>Type de dossier</span>
                <div class="wizard-progress"><span style="width: 33.3%;"></span></div>
            </div>
            ...
            <form action="{{ route('dossiers.step3') }}" method="POST">
                ...
                <div class="wizard-field">
                    <label for="type_dossier_id" class="wizard-label">Type de dossier <span class="text-danger">*</span></label>
                    <select class="form-select wizard-input @error('type_dossier_id') is-invalid @enderror" name="type_dossier_id" id="type_dossier_id" required>
