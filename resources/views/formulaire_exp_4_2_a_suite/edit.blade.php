    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div style="display:flex;align-items:center;gap:15px;margin-bottom:25px;">
                ...
                <div>
                    <h1 style="margin:0;font-size:34px;font-weight:800;">Modifier un Formulaire EXP-4.2 a) (suite)</h1>
            ...
            <div class="card" style="border-radius:16px; padding:24px;">
                @include('formulaire_exp_4_2_a_suite.form', [
                    'action' => route('formulaire_exp_4_2_a_suite.update', $formulaireExp42ASuite),
                    'method' => 'PUT',
                    'buttonLabel' => 'Mettre à jour le Formulaire EXP-4.2 a) (suite)',
                    'formulaireExp42ASuite' => $formulaireExp42ASuite,
                    'dossiers' => $dossiers ?? [],
                ])
            </div>
        </div>
