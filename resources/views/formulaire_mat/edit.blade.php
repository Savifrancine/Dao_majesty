    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div style="display:flex;align-items:center;gap:15px;margin-bottom:25px;">
                ...
                <div>
                    <h1 style="margin:0;font-size:34px;font-weight:800;">Modifier le formulaire MAT</h1>
            ...
            <div class="card" style="border-radius:16px; padding:24px;">
                @include('formulaire_mat.form', [
                    'action' => route('formulaire_mat.update', $formulaireMat),
                    'method' => 'PUT',
                    'buttonLabel' => 'Enregistrer les modifications',
                    'formulaireMat' => $formulaireMat,
                ])
            </div>
        </div>
    </div>
