            ...
            <div class="card" style="border: none; border-radius: 12px; box-shadow: var(--shadow-md);">
                <div class="card-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 12px 12px 0 0;">
                    <h4 class="mb-0" style="font-weight: 700;">
                        <i class="fas fa-file-pdf me-2"></i>Créer un Formulaire PER
                    </h4>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('formulaire_per.store') }}" method="POST" id="formulairePERForm">
                        @csrf
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nom_candidat') is-invalid @enderror" id="nom_candidat" name="nom_candidat" value="{{ old('nom_candidat') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control @error('qualifications') is-invalid @enderror" id="qualifications" name="qualifications" rows="3" placeholder="Ingénieur Génie électrique et informatique, etc.">{{ old('qualifications') }}</textarea>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nom_employeur') is-invalid @enderror" id="nom_employeur" name="nom_employeur" value="{{ old('nom_employeur') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('emploi_tenu') is-invalid @enderror" id="emploi_tenu" name="emploi_tenu" value="{{ old('emploi_tenu') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control @error('adresse_employeur') is-invalid @enderror" id="adresse_employeur" name="adresse_employeur" rows="2" required>{{ old('adresse_employeur') }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="tel" class="form-control @error('telecopie') is-invalid @enderror" id="telecopie" name="telecopie" value="{{ old('telecopie') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('contact_personnel') is-invalid @enderror" id="contact_personnel" name="contact_personnel" value="{{ old('contact_personnel') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('nombre_annees_employeur') is-invalid @enderror" id="nombre_annees_employeur" name="nombre_annees_employeur" value="{{ old('nombre_annees_employeur') }}" min="0" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="experiencesContainer">
                                @if(old('experiences'))
                                    @foreach(json_decode(old('experiences'), true) ?? [] as $exp)
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('lieu_signature') is-invalid @enderror" id="lieu_signature" name="lieu_signature" value="{{ old('lieu_signature') }}">
                        ...
                        <div class="mt-5 pt-4 border-top">
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-success btn-lg">
                                    <i class="fas fa-save me-2"></i>Créer le Formulaire
                                </button>
